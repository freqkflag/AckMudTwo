...
const   struct  cmd_type        cmd_table       [] =
{
 ...
 /*command table modified by Aeria*/
    ...
    { "istats",         do_istats,      POS_SLEEPING,   0,   LOG_NORMAL,
     C_TYPE_IMC, C_SHOW_ALWAYS },
    { "rchannels",      do_rchannels,   POS_SLEEPING,   0,   LOG_NORMAL,
     C_TYPE_IMC, C_SHOW_ALWAYS },
...
/* one or more of the poses crash us  */
    ...
    { "mailq",          do_mailqueue,   POS_DEAD,        86,   LOG_NORMAL,
     C_TYPE_IMC, C_SHOW_ALWAYS},
    { "rchanset",       do_rchanset,    POS_DEAD,      L_DEI,   LOG_NORMAL,
     C_TYPE_IMC, C_SHOW_NEVER},
    {"ichannels",       do_ichannels,   POS_RESTING,     30,  LOG_NORMAL,
     C_TYPE_IMC, C_SHOW_ALWAYS },
    {"icommand",        do_icommand,    POS_RESTING,  L_GOD,  LOG_NORMAL,
     C_TYPE_IMC, C_SHOW_ALWAYS },
    {"isetup",          do_isetup,      POS_RESTING,  L_GOD,  LOG_NORMAL,
     C_TYPE_IMC, C_SHOW_ALWAYS },
    {"ilist",           do_ilist,       POS_RESTING,     30,  LOG_NORMAL,
     C_TYPE_IMC, C_SHOW_ALWAYS},
